...
const controllers = require("./REST_routes/appointments");
...
(async () => {
  try {
    ...
    // await mongoose.connect('mongodb://localhost:27020/mydb',
    ...
    app.use("/api/v1/appointments", controllers);
    // all record
    app.get("/api/orders", function (req, res) {
      //app.get("/api/v1/appointments/getDataFull", function (req, res) {
