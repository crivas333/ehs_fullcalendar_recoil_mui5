...
import {SEARCH_PATIENT_BY_LASTNAME, AUTOCOMPLETE_SEARCH_PATIENT_BY_ID} from '../../../apolloConfig/gqlQueries'
...
const loadPatient = async (input) => {
  try{
    const res = await client.query({query: AUTOCOMPLETE_SEARCH_PATIENT_BY_ID, variables: { id: input } });  
