...
class Scheduler extends React.Component {    
    constructor() {
        ...
        this.queryAutoComplete = new Query().from('Patients').select(['lastName', 'historyId']).take(15);
    ...
    // onChangePatient1(args) {
    //   //args.value=this.context.currentPatient.lastName
    //   console.log("onChagePatient: ",args)
    // }
//value={this.context.currentPatient.lastName} 
